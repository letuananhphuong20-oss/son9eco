          ...
          <div className="section-container">
            <div className="grid lg:grid-cols-2 gap-20 items-center">
              <div>
                ...
                <div className="space-y-4">
                  {[
                    { title: lang === 'vi' ? 'Chiết khấu NPP ưu việt cao nhất' : 'Highest distributor discount', icon: <Palette size={20} /> },
                    { title: lang === 'vi' ? 'Hỗ trợ Showroom & Máy pha màu' : 'Showroom & Color machine support', icon: <ChevronRight size={20} /> },
                  ].map((item, i) => (
